<template>
  <div class="sales-board">
      ...
      <div class="sales-board-form">
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                <v-counter :max="50" :min="20" @on-change="onParamChange('buyNum',$event)"></v-counter>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
      ...
      <my-dialog :is-show="isPayDialogShow" @on-close="closePayDialog">
...
export default{
  ...
  methods:{
    ...
    getPrice(){
      let buyVersionAsrray = _.map(this.versions,(item)=>{
        return item.value
      })
      let reqParams = {
